...
class $c_Lwebapp_App$ extends $c_O {
  main__AT__V(args) {
    ...
    const ev$1 = new $c_sjsr_AnonFunction1(((this$4$1) => ((f$3$2) => {
      const f$3 = $as_F0(f$3$2);
      return $m_sjs_js_Any$().fromFunction0__F0__sjs_js_Function0(f$3)
    }))(this));
    const array$1 = [$$x7, $$x6.$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($$x5, new $c_Lscalatags_LowPriorityImplicits$$anon$2(this$10, ev$1))];
    const btn1 = $$x8.apply__sci_Seq__Lscalatags_JsDom$TypedTag(new $c_sjsr_WrappedVarArgs(array$1));
    const child = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
    const child1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
    const child2 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
    child.textContent = "1. Documents-A";
...
//# sourceMappingURL=scala-js-repo-fastopt.js.map
